// Monochrome SVG icons (inherit color via currentColor → white/cyan)
type IconProps = { className?: string }

const base = 'w-full h-full'

export function IconATS({ className = '' }: IconProps) {
  return (
    <svg className={`${base} ${className}`} fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
...
export function IconTemplate({ className = '' }: IconProps) {
  return (
    <svg className={`${base} ${className}`} fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v3H4V5zM4 11h6v8H5a1 1 0 01-1-1v-7zM14 11h6v7a1 1 0 01-1 1h-5v-8z" />
    </svg>
  )
}
...
export function IconMonitor({ className = '' }: IconProps) {
  return (
    <svg className={`${base} ${className}`} fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 17v2m6-2v2M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
    </svg>
  )
}
...
export function IconBank({ className = '' }: IconProps) {
  return (
    <svg className={`${base} ${className}`} fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 21h18M4 10h16M5 10l7-5 7 5M6 10v8m4-8v8m4-8v8m4-8v8" />
    </svg>
  )
}
...
export function IconStar({ className = '' }: IconProps) {
  return (
    <svg className={`${base} ${className}`} fill="currentColor" viewBox="0 0 20 20">
