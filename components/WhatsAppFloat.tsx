  ...
  return (
    <div className="whatsapp-float">
      ...
      <a
        ...
        className="w-14 h-14 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full flex items-center justify-center shadow-xl hover:shadow-2xl transition-all transform hover:scale-110"
        onClick={() => setTooltip(false)}
      >
